"""Middleware for job_scheduler request processing."""
import logging
import time
...
class JobSchedulerMiddleware:
    """Middleware that handles job_scheduler processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("job_scheduler middleware error: %s", e)
                raise
            finally:
