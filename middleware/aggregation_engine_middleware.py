"""Middleware for aggregation_engine request processing."""
import logging
import time
...
class AggregationEngineMiddleware:
    """Middleware that handles aggregation_engine processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("aggregation_engine middleware error: %s", e)
                raise
            finally:
