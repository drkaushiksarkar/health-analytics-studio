"""Middleware for circuit_breaker request processing."""
import logging
import time
...
class CircuitBreakerMiddleware:
    """Middleware that handles circuit_breaker processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("circuit_breaker middleware error: %s", e)
                raise
            finally:
