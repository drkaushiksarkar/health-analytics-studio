"""Middleware for log_aggregation request processing."""
import logging
import time
...
class LogAggregationMiddleware:
    """Middleware that handles log_aggregation processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("log_aggregation middleware error: %s", e)
                raise
            finally:
