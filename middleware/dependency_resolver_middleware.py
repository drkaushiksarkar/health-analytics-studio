"""Middleware for dependency_resolver request processing."""
import logging
import time
...
class DependencyResolverMiddleware:
    """Middleware that handles dependency_resolver processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("dependency_resolver middleware error: %s", e)
                raise
            finally:
