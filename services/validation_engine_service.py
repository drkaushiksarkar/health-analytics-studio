"""Service layer for validation_engine operations."""
import logging
...
class ValidationEngineService:
    """Service for validation_engine domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> ValidationEngineResult:
        ...
        try:
            ...
            return ValidationEngineResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return ValidationEngineResult(success=False, error=str(e))
