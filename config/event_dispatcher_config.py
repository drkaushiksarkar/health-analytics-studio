"""Configuration for event_dispatcher subsystem."""
import os
...
class EventDispatcherConfig:
    """Configuration parameters for event_dispatcher."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "EVENT_DISPATCHER") -> "EventDispatcherConfig":
        return cls(
