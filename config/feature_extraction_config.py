"""Configuration for feature_extraction subsystem."""
import os
...
class FeatureExtractionConfig:
    """Configuration parameters for feature_extraction."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "FEATURE_EXTRACTION") -> "FeatureExtractionConfig":
        return cls(
