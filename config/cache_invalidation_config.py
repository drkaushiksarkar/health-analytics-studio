"""Configuration for cache_invalidation subsystem."""
import os
...
class CacheInvalidationConfig:
    """Configuration parameters for cache_invalidation."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "CACHE_INVALIDATION") -> "CacheInvalidationConfig":
        return cls(
