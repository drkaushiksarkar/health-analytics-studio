...
interface PredictedCasesChartProps {
  data: TimeSeriesDataPoint[];
}

export default function PredictedCasesChart({ data }: PredictedCasesChartProps) {
  if (data.length === 0) {
    return (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Predicted Cases</CardTitle>
