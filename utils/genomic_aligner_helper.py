"""Utility helper for genomic_aligner operations."""
import logging
...
class GenomicAlignerHelper:
    """Helper class for genomic_aligner processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing genomic_aligner helper")
