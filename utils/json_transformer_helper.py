"""Utility helper for json_transformer operations."""
import logging
...
class JsonTransformerHelper:
    """Helper class for json_transformer processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing json_transformer helper")
